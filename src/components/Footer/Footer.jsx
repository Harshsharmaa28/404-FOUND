      ...
      <div className=" bg-black w-full h-[20rem] flex text-white rounded-2xl">
        ...
        <div className=" vsm:max-sm:hidden flex">
          <div className=" ml-36 py-7">
            ...
            <div className=" mt-4 flex w-[20rem] flex-wrap">
              {" "}
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Obcaecati, aspernatur soluta! Assumenda eligendi esse architecto
              ullam nulla consequuntur minus culpa illo eque. Id?
            </div>
            <button
              type="button"
